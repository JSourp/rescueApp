...
namespace rescueApp
{
	...
	public class CreateDocumentMetadataRequest
	{
		...
		[Required(AllowEmptyStrings = false)]
		public string? ImageUrl { get; set; } // Base URL generated by previous step
	...
	public class CreateDocumentMetadata
	{
			...
			int animalId) // Animal ID from route
		{
			...
			try
			{
				...
				{
					AnimalId = animalId,
					DocumentType = metadataRequest.DocumentType!,
					FileName = metadataRequest.FileName!,
					BlobName = metadataRequest.BlobName!,
					ImageUrl = metadataRequest.ImageUrl!,
			...
			{
				_logger.LogError(ex, "Error saving document metadata for Animal ID: {AnimalId}. blob_name: {blob_name}", animalId, metadataRequest.BlobName);
