...
export const HeroSection = () => {
	...
	const missionStatement = "Help us build a true no-kill rescue from the ground up. Our mission is to provide a second chance for animals in need, and we are starting with what matters most: a compassionate foster network. As we work towards our long-term goal of a physical rescue and sanctuary, your help right now is essential. You can become a part of our founding story by signing up to foster, volunteer, or making a foundational donation.";
