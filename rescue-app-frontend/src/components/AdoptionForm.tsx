...
export default function AdoptionForm({ onClose }: AdoptionFormProps) {
  const prefilledSubject = `Adoption Application`;
  ...
  return (
	 <div className="flex flex-col max-h-[85vh]">
		...
		<div className="flex-shrink-0 p-5 bg-orange-600">
			 <h3 className="text-lg text-white text-center font-semibold">Adoption Application</h3>
		</div>
			...
			{!isSuccess ? (
				<form onSubmit={handleSubmit(onSubmit)} noValidate>
					...
					{/* --- Adoption Specific Section --- */}
					 {/* Which Animal */}
					<div className="mb-4">
						<label htmlFor="which_animal" className="block mb-2 text-sm text-gray-600 dark:text-gray-400">Which animal(s) are you interested in?</label>
						<textarea
							id="which_animal"
							rows={1}
							{...register("which_animal")}
							className={`w-full p-2 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring focus:ring-orange-100 dark:focus:ring-orange-900 focus:border-orange-500 dark:focus:border-orange-500`}
						 />
					</div>
